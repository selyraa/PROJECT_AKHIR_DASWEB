...
<body>
    <?php
        ...
        ON p.idPembayaran = t.idPembayaran INNER JOIN user u ON u.idUser = t.idUser WHERE t.idUser = '$idUser' ORDER BY t.idTransaksi");
    ...
    <div class="col-md-12 text-center">
        <button>
            <a style="text-decoration: none; color: white;" href="home.php"><b>Home</b> <i class="fa-solid fa-arrow-right" style="padding-left: 10px;"></i></a>
        </button>
    </div>
</body>
</html>